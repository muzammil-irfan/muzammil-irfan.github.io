//question 4
function Myfunc(name,gender,address,education,profession){
    this.name = name;
    this.gender = gender;
...
function submit(){
    ...
    var gender = document.getElementsByClassName("gen").value;
    var address = document.getElementById("add").value;
    var edu = document.getElementById("edu").getElementsByClassName.value;
    var pro = document.getElementById("pro").value;
    var total = new Myfunc(name,gender,address,edu,pro);
