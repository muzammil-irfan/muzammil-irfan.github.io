...
// const svgButtonRemovingDiv = ()=>{
//     // const svgButton = document.getElementsByClassName('svgButton');
//     // console.log(svgButton.parentNode)
//     alert('done')
// };
// const svgButton = document.getElementsByClassName('svgButton');
// for (let element of svgButton) {
//     element.addEventListener('click', svgButtonRemovingDiv);
// };
